        ...
        <>
            ...
            <button className="w-14 h-12 bg-purple-100 hover:bg-purple-200 flex justify-center items-center rounded-r-md">
                <div className="w-6 h-6 text-white">
                    <svg focusable="false" viewBox="0 0 24 24" role="img" aria-label="Search" fill="currentColor" stroke="currentColor">
                    <title>Search</title><path d="M18.75 17.94l-4.53-4.53A5.44 5.44 0 0015.5 9.9a5.51 5.51 0 10-2 4.22l4.5 4.53a.52.52 0 00.71 0 .51.51 0 00.04-.71zM5.5 9.9a4.5 4.5 0 114.5 4.5 4.51 4.51 0 01-4.5-4.5z"></path></svg>
                </div>
            </button>
        </>
    )
